...
const features = [
  ...
  { icon: '🌡️', title: 'Smart Temp & Humidity', desc: 'Automatically computes dual optimal temperature and relative humidity targets for all stored vegetable varieties.' },
  { icon: '🧪', title: 'Gas Sensor Spoilage Detection', desc: 'IoT MQ-135 / Ethylene gas sensor detects early organic decomposition and notifies farmers before produce spoils.' },
...
const steps = [
  ...
  { n: '4', t: 'IoT & Gas Monitoring', d: 'Sensors monitor temperature, humidity, solar/battery power, and gas spoilage levels 24/7.' },
];
    ...
    <div>
      <section className="hero">
        <div className="hero-content">
          ...
          <h1>Solar-Powered <span>Smart Cold Storage</span> with Gas Spoilage Detection</h1>
          <p>
            Preserve post-harvest freshness, prevent vegetable spoilage with IoT gas sensors, and dynamically adapt cooling load to ambient weather conditions.
          </p>
          ...
          <div className="hero-stats">
            ...
            <div className="stat-card"><div className="stat-value">0–16°C</div><div className="stat-label">Precise Temp Control</div></div>
            <div className="stat-card"><div className="stat-value">MQ-135</div><div className="stat-label">Gas Spoilage Sensor</div></div>
          </div>
        </div>
      </section>
